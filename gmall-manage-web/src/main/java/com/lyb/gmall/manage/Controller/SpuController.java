...
import com.lyb.gmall.manage.util.PmsUploadUtil;
...
public class SpuController {
    ...
    @ResponseBody
    public String updateSpuInfo(@RequestBody PmsProductInfo pmsProductInfo){
        spuService.updateSpuInfo(pmsProductInfo);
        return "success";
    }
